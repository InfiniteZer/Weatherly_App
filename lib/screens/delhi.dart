...
void main() => runApp(MaterialApp(title: "Weatherly", home: Del()));
...
class _DelState extends State<Del> {
  ...
  Future getWeather() async {
    var url = Uri.parse(
        "https://api.openweathermap.org/data/2.5/weather?q=Delhi&units=metric&appid=9c00fa74213b672289a880f6df770c57");
